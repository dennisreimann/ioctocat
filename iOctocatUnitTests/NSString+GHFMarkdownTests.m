...
- (void)testAttributedStringFromMarkdownWithBoldAtStringBounds {
    ...
    expect([@"__This__ is __bold__" attributedStringFromMarkdown]).to.equal(expected);
}
...
- (void)testAttributedStringFromMarkdownWithItalicAtStringBounds {
    ...
    expect([@"_This_ is _italic_" attributedStringFromMarkdown]).to.equal(expected);
}
...
- (void)testAttributedStringFromMarkdownWithCodeInlineAtStringBounds {
    ...
    expect([@"`This` is `code inline`" attributedStringFromMarkdown]).to.equal(expected);
}
...
- (void)testAttributedStringFromMarkdownWithCodeBlocksAtStringBounds {
    ...
    expect([@"```ruby\nputs 'Test'\n```\n\na code block\n\n```javascript\nalert('Test');\n```" attributedStringFromMarkdown]).to.equal(expected);
}
